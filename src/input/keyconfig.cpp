...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,        	KeyMappingType::ASSIGNABLE,  kf_Dissipate3(),                                               "Dissipate",                    N_("Dissipate quickly over an area"),               {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LALT,       KEY_CODE::KEY_D             } }}));
